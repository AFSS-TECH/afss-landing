...
// ships to the browser. Supabase verifies the caller's JWT before this runs
// (function deployed without --no-verify-jwt), so only signed-in demo
// sessions (anonymous or not) can reach it.
