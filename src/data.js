...
export const portfolioProjects = [
  ...
  { slug:'radiance-aesthetic-clinic', cat:'Landing Page', catSlug:'landing-page', title:'Radiance Aesthetic Clinic', tagline:'Landing page klinik estetika: katalog treatment, galeri before-after, dan booking konsultasi langsung ke WhatsApp', c:'#1B2A22', c2:'#4E9E7C', kind:'land', budget:'Rp 12 Jt', result:'Booking Konsultasi +95%', result2:'Waktu respons admin turun dari semalam jadi hitungan jam',
  ...
  { slug:'skilva-digital-bootcamp', cat:'Landing Page', catSlug:'landing-page', title:'Skilva Digital Bootcamp', tagline:'Landing page pendaftaran bootcamp digital: kurikulum per batch, testimoni alumni, dan pendaftaran online otomatis', c:'#22242B', c2:'#C98A2E', kind:'land', budget:'Rp 16 Jt', result:'Pendaftaran Batch +140%', result2:'Panitia tidak lagi rekap manual pendaftar satu-satu',
