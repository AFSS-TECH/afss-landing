...
export const pricing = [
  ...
  },
  {
    ...
    price: 'Rp 8 Jt',
    note: 'mulai dari',
    desc: 'Sistem manajemen internal ringan untuk mencatat, memantau, dan melaporkan data bisnis secara digital.',
    feats: ['Login multi-user & role', 'CRUD data & tabel lengkap', 'Laporan & export Excel/PDF', 'Responsif di semua perangkat'],
    hot: false,
  },
  {
  ...
  },
  {
    ...
    price: 'Rp 20 Jt',
    note: 'mulai dari',
    desc: 'ERP custom yang menyatukan keuangan, inventory, SDM, dan operasional sesuai alur kerja bisnis Anda.',
  ...
  },
  {
    ...
    price: 'Rp 35 Jt',
    note: 'mulai dari',
    desc: 'Toko online custom dengan payment gateway, katalog produk, manajemen stok, dan dashboard penjualan.',
    feats: ['Payment gateway (Midtrans / Xendit)', 'Katalog & manajemen stok', 'Dashboard penjualan & laporan', 'SEO-ready & mobile-first'],
    hot: false,
  },
  {
    ...
    price: 'Rp 50 Jt',
    note: 'mulai dari',
    desc: 'Platform multi-vendor tempat seller mendaftar, upload produk, dan buyer bertransaksi dalam satu ekosistem.',
    feats: ['Multi-vendor: seller & buyer', 'Komisi & settlement otomatis', 'Manajemen dispute & review', 'Dashboard admin & laporan lengkap'],
    hot: false,
  },
]
...
export const pricingBundles = [
  {
    ...
    desc: 'Cocok untuk UMKM yang baru go-digital. Online presence profesional dengan budget terbatas — langsung siap dapat pelanggan.',
  ...
  },
  {
    ...
    desc: 'Company profile yang kuat ditambah sistem manajemen internal — tampil profesional ke luar, operasional rapi ke dalam.',
  ...
  },
  {
    ...
    tag: 'Solusi korporat',
    desc: 'ERP, dashboard analitik, dan aplikasi mobile dalam satu ekosistem terintegrasi — untuk bisnis skala menengah ke atas.',
  ...
  },
  {
    ...
    tag: 'Skala besar',
    desc: 'Platform marketplace lengkap dengan aplikasi mobile untuk buyer dan seller — siap bersaing di level berikutnya.',
...
export const faqs = [
  { q: 'Berapa biaya pembuatan website atau aplikasi?', a: 'Landing page mulai Rp 1,5 juta, company profile Rp 6 juta, mini dashboard Rp 8 juta, ERP Rp 20 juta, aplikasi mobile Rp 15 juta, toko online Rp 35 juta, dan marketplace Rp 50 juta. Semua harga adalah estimasi awal — final menyesuaikan ruang lingkup yang disepakati setelah konsultasi gratis.' },
