...
export const stats = [
  ...
  },
  {
    id: 'warranty', n: 90,
    i18n: {
      id: { suffix: ' Hari', label: 'Maks. Masa Garansi Bug' },
      en: { suffix: ' Days', label: 'Max Bug-Warranty Period' },
      zh: { suffix: '天', label: '最长错误质保期' },
    },
  },
  {
  ...
  {
    id: 'industry', n: 8, suffix: '+',
    i18n: {
      id: { label: 'Industri Dilayani' },
      en: { label: 'Industries Served' },
      zh: { label: '服务行业' },
    },
  },
]
...
export const pricing = [
  {
    ...
    i18n: {
      id: {
        name: 'Landing Page', category: 'Website', normalPrice: 'Rp 1,5 Jt', price: 'Rp 1 Jt', save: 'Hemat Rp 500rb', note: 'mulai dari',
      ...
      en: {
        name: 'Landing Page', category: 'Website', normalPrice: 'Rp 1.5M', price: 'Rp 1M', save: 'Save Rp 500K', note: 'starting from',
      ...
      zh: {
        name: '落地页', category: '网站', normalPrice: 'Rp 1.5M', price: 'Rp 1M', save: '节省 Rp 500K', note: '起',
  ...
  },
  {
    ...
    i18n: {
      id: {
        name: 'Company Profile', category: 'Website', normalPrice: 'Rp 4,5 Jt', price: 'Rp 3,3 Jt', save: 'Hemat Rp 1,2 Jt', note: 'mulai dari',
      ...
      en: {
        name: 'Company Profile', category: 'Website', normalPrice: 'Rp 4.5M', price: 'Rp 3.3M', save: 'Save Rp 1.2M', note: 'starting from',
      ...
      zh: {
        name: '企业官网', category: '网站', normalPrice: 'Rp 4.5M', price: 'Rp 3.3M', save: '节省 Rp 1.2M', note: '起',
  ...
  },
  {
    ...
    i18n: {
      id: {
        name: 'Software Custom', category: 'Software', normalPrice: 'Rp 8 Jt', price: 'Rp 6 Jt', save: 'Hemat Rp 2 Jt', note: 'mulai dari',
      ...
      en: {
        name: 'Custom Software', category: 'Software', normalPrice: 'Rp 8M', price: 'Rp 6M', save: 'Save Rp 2M', note: 'starting from',
      ...
      zh: {
        name: '定制软件', category: '软件', normalPrice: 'Rp 8M', price: 'Rp 6M', save: '节省 Rp 2M', note: '起',
  ...
  },
  {
    ...
    i18n: {
      id: {
        name: 'Aplikasi Mobile', category: 'Mobile', normalPrice: 'Rp 15 Jt', price: 'Rp 12 Jt', save: 'Hemat Rp 3 Jt', note: 'mulai dari',
      ...
      en: {
        name: 'Mobile App', category: 'Mobile', normalPrice: 'Rp 15M', price: 'Rp 12M', save: 'Save Rp 3M', note: 'starting from',
      ...
      zh: {
        name: '移动应用', category: '移动端', normalPrice: 'Rp 15M', price: 'Rp 12M', save: '节省 Rp 3M', note: '起',
  ...
  },
  {
    ...
    i18n: {
      id: {
        name: 'ERP Custom', category: 'Software', normalPrice: 'Rp 28 Jt', price: 'Rp 24 Jt', save: 'Hemat Rp 4 Jt', note: 'mulai dari',
      ...
      en: {
        name: 'Custom ERP', category: 'Software', normalPrice: 'Rp 28M', price: 'Rp 24M', save: 'Save Rp 4M', note: 'starting from',
      ...
      zh: {
        name: '定制ERP系统', category: '软件', normalPrice: 'Rp 28M', price: 'Rp 24M', save: '节省 Rp 4M', note: '起',
  ...
  },
  {
    ...
    i18n: {
      id: {
        name: 'E-Commerce', category: 'E-Commerce', normalPrice: 'Rp 18 Jt', price: 'Rp 14,5 Jt', save: 'Hemat Rp 3,5 Jt', note: 'mulai dari',
        desc: 'Toko online custom dengan payment gateway lokal, manajemen produk & stok, dan dashboard penjualan.',
        feats: ['Payment gateway Midtrans / Xendit', 'Manajemen produk, kategori & stok', 'Kalkulasi ongkir otomatis', 'Dashboard & laporan penjualan'],
      },
      en: {
        name: 'E-Commerce', category: 'E-Commerce', normalPrice: 'Rp 18M', price: 'Rp 14.5M', save: 'Save Rp 3.5M', note: 'starting from',
        desc: 'A custom online store with local payment gateways, product & stock management, and a sales dashboard.',
        feats: ['Midtrans / Xendit payment gateway', 'Product, category & stock management', 'Automatic shipping cost calculation', 'Sales dashboard & reports'],
      },
      zh: {
        name: '电商平台', category: '电商', normalPrice: 'Rp 18M', price: 'Rp 14.5M', save: '节省 Rp 3.5M', note: '起',
  ...
  },
  {
    ...
    i18n: {
      id: {
        name: 'Marketplace', category: 'E-Commerce', normalPrice: 'Rp 65 Jt', price: 'Rp 58 Jt', save: 'Hemat Rp 7 Jt', note: 'mulai dari',
      ...
      en: {
        name: 'Marketplace', category: 'E-Commerce', normalPrice: 'Rp 65M', price: 'Rp 58M', save: 'Save Rp 7M', note: 'starting from',
      ...
      zh: {
        name: '多商户平台', category: '电商', normalPrice: 'Rp 65M', price: 'Rp 58M', save: '节省 Rp 7M', note: '起',
