...
export const products = [
  ...
  {
    slug: 'jasa-pembuatan-crm',
    icon: 'fa-solid fa-users-gear',
    name: 'Sistem CRM (Customer Relationship Management)',
    desc: 'Kelola semua data pelanggan, leads, follow-up, dan pipeline penjualan dalam satu sistem — tim sales lebih produktif, tidak ada prospek yang terlewat.',
    metric: 'Pipeline terkelola',
