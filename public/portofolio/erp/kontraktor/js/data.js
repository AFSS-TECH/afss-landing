...
const DEFAULT_DATA = {
  ...
  docUploads: [
    // PRJ-001 STG-001
    { id:'DOC-001', stage_id:'STG-001', project_id:'PRJ-001', title:'Galian Bored Pile Selesai',       caption:'Galian bored pile diameter 60cm kedalaman 18m. Total 48 titik selesai 100%. Tanah keras sesuai hasil soil test dan NSPT.',              type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=500&q=75', uploaded_by:'Mandor Hasan',  uploaded_at:'2024-09-18', kinerja_note:'Selesai H-3 dari jadwal, cuaca mendukung' },
    { id:'DOC-002', stage_id:'STG-001', project_id:'PRJ-001', title:'Pengecoran Bored Pile',           caption:'Pengecoran bored pile menggunakan ready mix K-350. Slump test 12cm OK. Semua 48 titik sudah dicor menggunakan pipa tremie.',           type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1590496793929-36417d3117de?w=500&q=75', uploaded_by:'PM Rudi H.',    uploaded_at:'2024-10-02', kinerja_note:'Kualitas beton sesuai spec, tidak ada reject' },
    // PRJ-001 STG-002
    { id:'DOC-003', stage_id:'STG-002', project_id:'PRJ-001', title:'Pembesian Pile Cap Zone A',       caption:'Pembesian pile cap zone A selesai menggunakan besi D25 sesuai shop drawing. Menunggu bekisting dan pengecoran.',                        type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=500&q=75', uploaded_by:'Mandor Hasan',  uploaded_at:'2024-11-05', kinerja_note:'Zone A selesai, sedang lanjut zone B dan C' },
    { id:'DOC-004', stage_id:'STG-002', project_id:'PRJ-001', title:'Raft Slab Basement Cor',          caption:'Pengecoran raft slab basement area parkir bawah tanah. Volume beton ±840m³, menggunakan 4 unit concrete pump simultan.',               type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=500&q=75', uploaded_by:'PM Rudi H.',    uploaded_at:'2024-12-01', kinerja_note:'Pengecoran massal selesai dalam 1 shift, tidak ada cold joint' },
    // PRJ-001 STG-003
    { id:'DOC-005', stage_id:'STG-003', project_id:'PRJ-001', title:'Cor Kolom Lantai 2 Zona B',       caption:'Pengecoran kolom lantai 2 zona B menggunakan pump concrete. Mutu beton K-400. Beton sudah dibuka bekisting, permukaan baik.',            type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=500&q=75', uploaded_by:'PM Rudi H.',    uploaded_at:'2025-01-20', kinerja_note:'Progress sesuai schedule, kualitas baik' },
    { id:'DOC-006', stage_id:'STG-003', project_id:'PRJ-001', title:'Video Timelapse Progress Lt. 3',  caption:'Video timelapse pekerjaan lantai 3 selama 2 minggu. Semua kolom sudah dicor, sedang pekerjaan pembesian balok dan plat lantai.',       type:'video', drive_id:'', thumb_url:'', uploaded_by:'PM Rudi H.',    uploaded_at:'2025-02-20', kinerja_note:'Pekerjaan lantai 3 sudah 85%, estimasi selesai minggu depan' },
    { id:'DOC-007', stage_id:'STG-003', project_id:'PRJ-001', title:'Plat Lantai 4 Pengecoran',        caption:'Pengecoran plat lantai 4 menggunakan ready mix K-400 dengan aditif waterproofing. Luas ±1.200m², volume beton ±180m³.',               type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=500&q=75', uploaded_by:'Mandor Hasan',  uploaded_at:'2025-03-10', kinerja_note:'Selesai tepat waktu, cuaca cerah mendukung pengecoran' },
    // PRJ-001 STG-004
    { id:'DOC-008', stage_id:'STG-004', project_id:'PRJ-001', title:'Pembesian Kolom Lt. 5 Zona A',    caption:'Pembesian kolom lantai 5 zona A menggunakan besi D25 dan D19. Sudah terpasang 12 dari 18 kolom, menunggu bekisting.',                  type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&q=75', uploaded_by:'Mandor Hasan',  uploaded_at:'2025-04-10', kinerja_note:'Progres 70% zona ini, deviasi -6% dari target' },
    { id:'DOC-009', stage_id:'STG-004', project_id:'PRJ-001', title:'Progress Lt. 6 Minggu Ini',       caption:'Update progress lantai 6. Bekisting kolom sudah terpasang, menunggu giliran pengecoran. Kendala: delivery besi sempat terlambat 3 hari.',type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?w=500&q=75', uploaded_by:'PM Rudi H.',    uploaded_at:'2025-05-05', kinerja_note:'Delay 3 hari akibat keterlambatan material, sudah dikompensasi' },
    // PRJ-004 STG-008
    { id:'DOC-010', stage_id:'STG-008', project_id:'PRJ-004', title:'Pemancangan 120 Titik Selesai',   caption:'Pemancangan 120 titik tiang pancang spun pile Ø 40cm selesai 100%. Kedalaman rata-rata 24m, final set sesuai spesifikasi teknis.',      type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1565008576549-57569a49371d?w=500&q=75', uploaded_by:'PM Rudi H.',    uploaded_at:'2024-08-25', kinerja_note:'Selesai tepat waktu, 0 tiang reject dari total 120 titik' },
    // PRJ-004 STG-009
    { id:'DOC-011', stage_id:'STG-009', project_id:'PRJ-004', title:'Erection Kolom Baja WF 400',      caption:'Erection 48 kolom baja WF 400×200 selesai 100%. Semua sambungan las sudah diinspeksi oleh inspector internal dan sudah sesuai standar.', type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1513467653872-c56a0b8f78fc?w=500&q=75', uploaded_by:'Mandor Andi',   uploaded_at:'2024-11-20', kinerja_note:'Inspeksi las: 0 defect, semua passed NDT' },
    { id:'DOC-012', stage_id:'STG-009', project_id:'PRJ-004', title:'Video Erection Balok & Gording',  caption:'Video dokumentasi erection balok induk dan gording roof frame warehouse. Progress rangka atap sudah 90%, estimasi selesai dalam 2 minggu.',type:'video', drive_id:'', thumb_url:'', uploaded_by:'PM Rudi H.',    uploaded_at:'2024-12-15', kinerja_note:'Mundur 4 hari akibat hujan, sudah dikejar dengan lembur' },
    // PRJ-004 STG-010
    { id:'DOC-013', stage_id:'STG-010', project_id:'PRJ-004', title:'Pemasangan Atap Spandek 70%',     caption:'Pemasangan atap spandek 0.5mm progress 70%. Menggunakan self-drilling screw dan sealant pada sambungan. Estimasi selesai akhir bulan.',  type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=500&q=75', uploaded_by:'Mandor Andi',   uploaded_at:'2025-03-10', kinerja_note:'Progress baik, cuaca mendukung. On track dengan schedule' },
    { id:'DOC-014', stage_id:'STG-010', project_id:'PRJ-004', title:'Video Pasang Wall Cladding',       caption:'Video pemasangan wall cladding panel baja sisi utara warehouse. Ketebalan 0.5mm galvalum. Progress cladding 60% dari total area.',        type:'video', drive_id:'', thumb_url:'', uploaded_by:'Mandor Andi',   uploaded_at:'2025-04-01', kinerja_note:'Pemasangan rapi sesuai gambar, diverifikasi oleh PM dan pengawas MK' },
    // PRJ-002 STG-012
    { id:'DOC-015', stage_id:'STG-012', project_id:'PRJ-002', title:'Cor Pondasi Footplate Ruko',       caption:'Pengecoran pondasi footplate 24 titik selesai. Mutu beton K-250. Semua titik sudah dicor menggunakan truck mixer dan bucket concrete.',   type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&q=75', uploaded_by:'PM Andi P.',    uploaded_at:'2025-01-12', kinerja_note:'Selesai sesuai jadwal, tidak ada masalah teknis' },
    // PRJ-002 STG-013
    { id:'DOC-016', stage_id:'STG-013', project_id:'PRJ-002', title:'Kolom Lantai 1 Ruko Progress',    caption:'Pengecoran kolom lantai 1 sudah selesai 8 unit dari 12 unit ruko. Progress 67%. Sedang persiapan bekisting balok dan plat lantai 1.',      type:'image', drive_id:'', thumb_url:'https://images.unsplash.com/photo-1548438294-1ad5d5f4f063?w=500&q=75', uploaded_by:'Mandor Hasan',  uploaded_at:'2025-03-05', kinerja_note:'Progress sedikit di bawah target, dikejar dengan tambah shift sore' },
  ],
};
